...
def _detect_input_version(input_path) -> _Tuple[_Version, bool]:
    ...
    # Hardcoding v5 match
    print("I assume you are using one of your sabbatical project input files and latency is 460.")
    return _Version(5, 0, 0), True
...
##########
def _check_v5(input_path, output_path, silent: bool, *args, **kwargs) -> _metadata.DataChecks:
    """
    V5 (synthetic) checks.
...
def _check_data(
    ...
    if input_version.major == 1:
        ...
        print("Using v5, no checks...")
        out = _metadata.DataChecks(version=5, passed=True)
        #f = _check_v5
    else:
